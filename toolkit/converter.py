...
多平台输出：
- WeChat: 使用 WeChatConverter（本文件）
- 小红书: xhs_converter.XHSConverter
- 微博: weibo_converter.WeiboConverter
- 知乎/头条: 直接输出 Markdown（LLM改写后）
- 短视频: video_converter.VideoConverter

内容改写（口语化、段落短化、emoji注入等）由
skills/platform-adaptation/SKILL.md 的 LLM 流程完成。
