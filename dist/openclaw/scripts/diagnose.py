#!/usr/bin/env python3
"""
Diagnose which anti-AI measures are active in 爆款智坊 installation.
...
def format_text(checks, summary, recs):
    ...
    lines = ["爆款智坊 Anti-AI Diagnostic", "=" * 26, ""]
...
def main():
    parser = argparse.ArgumentParser(
        description="Diagnose which anti-AI measures are active in 爆款智坊 installation.",
    )
